...
from .box_rasterizer_vg import BoxRasterizerVG
from .semantic_rasterizer_vg import SemanticRasterizerVG


class SemBoxRasterizerVG(Rasterizer):
    ...
    def __init__(
            ...
            frames_to_plot: np.ndarray,
    ):
        super(SemBoxRasterizerVG, self).__init__()
        ...
        self.box_rast = BoxRasterizerVG(render_context, filter_agents_threshold, history_num_frames, frames_to_plot)
        self.sem_rast = SemanticRasterizerVG(render_context, semantic_map_path, world_to_ecef)
